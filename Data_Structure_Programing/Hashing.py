...
class Node:
	...
	def __init__(self, key, value):
                '''
               :param:key: passing the key
               :param:value: passing the value
...
class HashTable:
    ...
    # This method help to hashing the value
	def hash(self, key):
		hashsum = 0
    ...
    #this method help to isert the value
	...
	def remove(self, key):
		...
		if node is None:
			...
			return result
    #this method help to display the value
	def display(self):
		index = self.hash('0')
		node =self.buckets[index]
		while node is not None:
